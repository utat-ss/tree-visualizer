...
import { MergedComponentsComponent } from "/workspaces/tree-visualizer/client/src/app/components/merged-components/merged-components.component"
...
export default {
    component: MergedComponentsComponent,
    parameters: {
        layout: 'fullscreen',
    },
    decorators: [
